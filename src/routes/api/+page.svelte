...
<svelte:head>
  <title>{data.meta.title} - LogoLibrary</title>
...
<section
  class="bg-white dark:bg-purple-900 bg-[url('/images/hero-pattern_light.svg')] dark:bg-[url('/images/hero-pattern_dark.svg')]"
>
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-20 z-10 relative">
    <div class="flex items-center space-x-4 text-center justify-center">
      <h1
        class="mb-4 text-4xl font-bold tracking-tight leading-none dark:bg-purple-900 md:text-5xl lg:text-6xl dark:text-white"
      >
        API Reference
      </h1>
